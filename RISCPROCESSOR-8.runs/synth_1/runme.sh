...
HD_PWD='C:/Users/bup48/Documents/VivadoProjects/RISCPROCESSOR-8/RISCPROCESSOR-8.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Memorypath.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Memorypath.tcl
