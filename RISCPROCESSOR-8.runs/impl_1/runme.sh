...
HD_PWD='C:/Users/bup48/Documents/VivadoProjects/RISCPROCESSOR-8/RISCPROCESSOR-8.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Memorypath.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Memorypath.tcl -notrace
